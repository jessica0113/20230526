let points = [[1, -3], [5, -4], [4, -3],[9,1],[7,2],[8,5],[5,4],[5,5],[3,4],[4,9],[2,7],[0,10],[-2,7],[-4,8],[-3,3],[-5,6],[-5,4],[-8,5],[-7,2],[-9,1],[-4,-3],[-5,-4],[0,-3],[2,-7],[2,-6],[1,-3]]
 var stroke_colors = "C5979D-4B8F8C-2B193D-2C365E-ffafcc-bde0fe".split("-").map(a=>"#"+a)
 var fill_colors = "fb8500-ffb703-023047-219ebc-8ecae6-B8CDF8".split("-").map(a=>"#"+a)
 var monster_colors = "893168-4A1942-2E1C2B-FD5200-00CFC1-B8CDF8".split("-").map(a=>"#"+a)
 function preload(){
...
draw(){//畫怪物
  ...
  ellipse(0,0,this.r)
  stroke(255)
  line(-this.r/4,0,this.r/4,0)//眼睛的線
  //產生腳
  stroke(this.color)
  strokeWeight(6)
    noFill()
